...
abstract class Ecomtech_Savemypaquet_Model_Api_Resources_Abstract
{
    protected $endpoint;
    ...
    public function do_request($is_auth = 0, $fileurl=false)
    {
        try {
            $response = $this->api->make_api_call($this->request_method, $this->get_endpoint_path(), $this->get_request_data(), $is_auth, $fileurl);
